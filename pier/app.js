  ...
  _createClass(App, [{
    ...
    value: function loadMorePhotos(e) {
      ...
      _jquery2['default'].ajax({
        url: 'https://api.flickr.com/services/rest/' + '?method=flickr.photos.search' + '&api_key=49e55423859a4e5c5f45cb893441d891' + '&text=' + this.state.searchText + '&format=json' + '&per_page=21&page=' + this.state.pageNum + '&extras=url_m,url_c,url_l,url_h,url_o',
        dataType: 'jsonp',
